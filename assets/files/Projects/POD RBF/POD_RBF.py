...
def Coefficients_Truncation(Amplitudes, Reduced_Amplitudes, Model_Param):
    ...
    # Normalize model parameters
    pNorm = normalize_model_parameters(Model_Param, Model_Param)
...
# Normalize model parameters
Norm_Parameters = normalize_model_parameters(Input_param, Model_Parameters)
...
Coefficients_Truncation(Amplitudes, Reduced_Amplitudes, Model_Parameters)
